...
object AppConfig {
    ...
    const val PREF_COMMUNITY_LIKED = "pref_community_liked"
    const val PREF_STATS_TODAY_DATE = "pref_stats_today_date"
    const val PREF_STATS_TODAY_UP = "pref_stats_today_up"
    const val PREF_STATS_TODAY_DOWN = "pref_stats_today_down"
    ...
    const val TG_CHANNEL_URL = "https://t.me/cyberrageofficial"
