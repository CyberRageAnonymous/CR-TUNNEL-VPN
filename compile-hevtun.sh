...
#    com.cr.tunnel.service.TProxyService for the VpnService hev tun mode.
...
#    process by com.cr.tunnel.service.CoreRootService for the Root run mode. Same hev source,
